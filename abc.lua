...
local menu = {
	...
	antiaim_yaw = ui.new_combobox("AA", "Anti-aimbot angles", "Anti-Aim Yaw", "Dangerous", "Hybrid"),
	antiaim_options = ui.new_combobox("AA", "Anti-aimbot angles", "Anti-Aim based of", "Enemy Lethal"),
    antiaim_shot = ui.new_checkbox("AA", "Anti-aimbot angles", "Center jitter on-shot"),
}
...
ui.set_visible(aa_body_yaw,false)
ui.set_visible(aa_body_yaw_offset,false)
ui.set_visible(aa_freestand_body,false)
if ui.get(menu.main_aa) then
    aa_main=true
end
